...
export default function Collections({ onOpenCollection, onAddToCollection, addToast }) {
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10 sm:px-10">
      ...
      <p className="mb-4 font-mono text-[11px] uppercase tracking-[0.12em] text-muted">Arrow keys to choose · Enter to open in Library · A to add papers · H to hide/show in Library</p>
